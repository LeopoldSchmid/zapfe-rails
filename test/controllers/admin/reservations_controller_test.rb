...
class Admin::ReservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "reserves an available resource and reports a conflict" do
    post admin_order_reservations_url(@order), params: { reservation: { resource_id: @resource.id, starts_at: "2026-08-01T10:00", ends_at: "2026-08-01T22:00" } }
    ...
    post admin_order_reservations_url(other_order), params: { reservation: { resource_id: @resource.id, starts_at: "2026-08-01T18:00", ends_at: "2026-08-02T10:00" } }
